...
export default function Customers() {
  ...
  const fetchCustomers = async () => {
    ...
    try {
      ...
      const data = await (
        await api(
          `/api/fieldSearch/advancedSearch/Customer?page=${currentPage}&size=${itemsPerPage}`,
          {
            method: "POST",
            headers: {
...
<body>
                ...
                ${customers
                  .map(
                    ...
                    <tr>
                        ...
                        <td class="price">${customer.email || "N/A"}</td>
                        <td>
                            ${customer.mobile || "N/A"}
                        </td>
                    </tr>
    ...
    link.href = url;
    link.download = `customers-export-${
              ...
              {customers.map((customer) => (
                ...
                >
                  ...
                  <TableCell>
                    <Image
                      src={
                        customer.avatar || "/placeholder.svg?height=40&width=40"
                      }
                      alt={customer.name}
