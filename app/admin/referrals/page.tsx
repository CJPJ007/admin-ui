...
export default function Referrals() {
  ...
  const fetchReferrals = async () => {
    ...
    try {
      ...
      const data = await (
        await api(
          `/api/fieldSearch/advancedSearch/Referral?page=${currentPage}&size=${itemsPerPage}`,
          {
            method: "POST",
            headers: {
...
<body>
    <div class="container">
        ...
        <table>
            <thead>
                <tr>
                    <th>Referred By Person(Email/Mobile)/th>
                    <th>Referred Name/th>
                    <th>Referred Date</th>
            ...
            <tbody>
                ${referrals
                  .map(
                    ...
                    <tr>
                        <td>
                            <strong>${referral.email || referral.mobile}</strong>
                        </td>
    ...
    link.href = url;
    link.download = `referrals-export-${
                ...
                <div key={index} className="flex gap-3 mb-3 items-center">
                  ...
                  >
                    ...
                    <SelectContent className="bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200">
                      <SelectItem value="referredName">
                        Referred Name
                      </SelectItem>
                      <SelectItem value="referredEmail">
                        Referred Email
                      </SelectItem>
                      <SelectItem value="referredMobile">
                        Referred Mobile
                      </SelectItem>
            ...
            <TableBody>
              {referrals.map((referral) => (
                ...
                >
                  ...
                  <TableCell>{referral.referralAmount}</TableCell>
                  <TableCell>{referral.status}</TableCell>
                  <TableCell>{referral.createdAt}</TableCell>
                  <TableCell>{referral.completedAt || "N/A"}</TableCell>
                  <TableCell>
