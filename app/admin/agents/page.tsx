...
export default function Agents() {
  ...
  <div className="p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
    ...
    {showFilters && (
      <Card className="mb-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
          ...
          <Button variant="ghost" size="sm" onClick={() => setShowFilters(false)} className="text-gray-700 dark:text-gray-200">
            <X className="h-4 w-4" />
          </Button>
        </CardHeader>
        <CardContent>
          ...
          <div className="flex gap-3 mt-4">
            <Button variant="outline" onClick={addFilter} className="text-gray-700 dark:text-gray-200 border-gray-300 dark:border-gray-600">
    ...
    <Card className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
      <CardHeader>
        <CardTitle className="text-gray-900 dark:text-white">Agents List</CardTitle>
      </CardHeader>
      <CardContent>
              ...
              <TableRow key={agent.id}>
                  ...
                  {agent.propertiesSold?.length ? (
                    <div className="flex items-center gap-2">
                      ...
                      <Badge className="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-300">
                        {agent.propertiesSold.length}{" "}
                        {agent.propertiesSold.length === 1 ? "Property" : "Properties"}
                      </Badge>
                    </div>
                  ) : (
                ...
                <TableCell>
                  {agent.propertiesSold?.length ? (
                    <Badge className="bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-300">
                      ₹{calculateTotalSales(agent.propertiesSold).toLocaleString()}
                    </Badge>
                  ) : (
                ...
                <TableCell>
                  <div className="flex gap-2">
                    <Button variant="outline" size="sm" onClick={() => handleEdit(agent)} className="text-gray-700 dark:text-gray-200 border-gray-300 dark:border-gray-600">
        ...
        {formData.propertiesSold && formData.propertiesSold.length > 0 ? (
                      ...
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-2">
                            <Badge variant="secondary">{sale.property.type}</Badge>
                            <span className="text-sm text-gray-500 dark:text-gray-400">
                              {sale.property.bedrooms} bed • {sale.property.bathrooms} bath
                            </span>
                          </div>
                        </div>
                        <Button
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              handleSoldAmountChange(index, Number(e.target.value))
                            }
                            required
                            className="dark:bg-gray-700 dark:text-white dark:border-gray-600"
                          />
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            type="date"
                            value={sale.saleDate || ""}
                            onChange={(e) => handleSaleDateChange(index, e.target.value)}
                            className="dark:bg-gray-700 dark:text-white dark:border-gray-600"
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              handleCommissionAmount(index, Number(e.target.value))
                            }
                            required
                            className="dark:bg-gray-700 dark:text-white dark:border-gray-600"
                          />
          ...
          <Card className="border-2 border-dashed border-gray-300 dark:border-gray-600 dark:bg-gray-700">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">No properties sold yet</p>
              <Button
                type="button"
                variant="outline"
                onClick={() => setShowPropertyModal(true)}
      ...
      <div className="space-y-3">
        {properties.length > 0 ? (
          ...
          <div className="text-center py-8">
            <Building className="h-12 w-12 text-gray-400 dark:text-gray-500 mx-auto mb-4" />
            <p className="text-gray-500 dark:text-gray-300">No properties found</p>
            {propertySearchTerm && (
